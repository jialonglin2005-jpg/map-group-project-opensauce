      ...
      return Container(
        ...
        child: Row(
          ...
          children: [
            ...
            Text(
              ref.read(shoppingCartProvider.notifier).getItemQuantity(id).toString(),
              style: const TextStyle(fontSize: 14),
            ),
            const SizedBox(width: 8),
            IconButton(
              onPressed: () {
                ref.read(shoppingCartProvider.notifier).incrementItemQuantity(id);
              },
                ...
                Row(
                  ...
                  children: [
                    Text(
                      ...
                      IconButton(
                        onPressed: () {
                          ref.read(shoppingCartProvider.notifier).deleteItem(id);
                        },
